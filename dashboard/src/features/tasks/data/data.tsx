...
export const statuses: {
  ...
  { label: 'Green', value: 'green', icon: CircleCheckBig, severity: 'good' },
  { label: 'Amber', value: 'amber', icon: Clock, severity: 'warning' },
  { label: 'Red', value: 'red', icon: TriangleAlert, severity: 'critical' },
  { label: 'Unknown', value: 'unknown', icon: Clock, severity: 'neutral' },
]
